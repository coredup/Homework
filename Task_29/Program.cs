...
Console.WriteLine($"\nЗадачка  № 29. Ряд чисел преобразует в массив");
Console.Write("Введите ряд чисел для будущего массива, разделенных запятой : ");
...
void СheckNumber2 (int  series){
      ...
      ||series == '-')
      {
          ...
          Console.WriteLine($"Не правильный формат ввода символа. Введите цифры.");
